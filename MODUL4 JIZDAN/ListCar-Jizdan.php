  ...
  <ul class="dropdown-menu">
    ...
    <div class="container p-5">
        ...
        <!-- read -->
            <div class="row g-2">
            <?php
                $sql = "SELECT * FROM showroom_jizdan_table ORDER BY id_mobil ASC";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="row">
                                    <div class="col">
                                        <a href="Detail-Jizdan.php?id_mobil=<?php echo $mycar['id_mobil'];?>" class="btn btn-primary rounded-4">Detail</a>
                                    </div>
                                    <div class="col">
