...
<body style="background-color:#F5F5F5; ">
    ...
    <br>
            ...
            <div class="card mb-3">
                ...
                <div class="col-md-5">
                    <from action="Jizdan_MyBooking.php" method="GET">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="Name" value="Jizdan_1202204189" readonly>
                        </div>
                        ...
                        <form action="Jizdan_MyBooking.php" method="POST">
                          <button type="submit" class="btn btn-primary" style="padding-left: 3%; padding-right: 3%; width: 100%">
                          <a class="nav-link active text-light" href="Jizdan_MyBooking.php">
                                BOOK
                            </a>
                        </button>
                        </form>
