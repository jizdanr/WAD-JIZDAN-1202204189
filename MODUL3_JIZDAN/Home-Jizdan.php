  ...
  <body>
    ...
    <div class="container p-5">
        <div class="row vh-100 align-items-center">
            ...
            <!-- COLOM 1 -->
            <div class="col">
                <h2>Selamat datang di showroom Jizdan</h2>
                <br>
                ...
                <!-- btn -->
                <a href="ListCar-Jizdan.php" class="btn btn-primary fw-light px-4 py-2">My Car</a>
                <!-- end btn -->
                <div class="d-flex justify-content-start">
                    <div class="row mt-5">
                        ...
                        <div class="col">
                            <p>Jizdan Rizkiardi_120220189</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- COLOM 2 -->
            <div class="col">
                <img src="img/mobil.png" style="width: 480px" alt="">
            </div>
        </div>
    </div>
